...
urlpatterns = [
    ...
    path(
        "api/videos/<slug:slug>",
        videos_detail_by_slug,
        name="api_videos_detail_by_slug",
    ),
    path(
        "api/videos/<int:id>/recommended",
        videos_list_recommended,
        name="api_videos_list_recommended",
    ),
    ...
    path(
        "api/videos/<int:id>/register-view",
        videos_register_view,
        name="api_videos_register_view",
    ),
]
